      ...
      <div className="flex w-200 w-[90%] h-screen justify-center items-center">
        <div className="flex flex-col justify-center bg-white shadow-2xl w-[70%] h-[86%] text-black rounded-[30px]">
          ...
          <div className="flex flex-col items-center justify-center mb-[5%]">
            ...
            <input className="w-[55%] text-2xl mb-5 pb-3 focus:outline-none bg-transparent border-b-2 border-black" placeholder="Username" onChange={e => setUsername(e.target.value)} />
            <input className="w-[55%] text-2xl mb-5 pb-3 focus:outline-none bg-transparent border-b-2 border-black" placeholder="Email" onChange={e => setEmail(e.target.value)} />
            ...
            <div className="relative w-[55%] mb-[10]">
              <input id="confirmPassword-input" type={showPassword ? "text" : "password"} className="w-[100%] text-2xl mb-[10%] pb-3 focus:outline-none bg-transparent border-b-2 border-black" placeholder="Confirm Password" onChange={e => setConfirmPassword(e.target.value)} />
              <button id="toggle-button" type="button" data-toggle-password='{ "target": "#password-input" }' className="absolute -top-2 -end-2 p-3.5 rounded-e-md focus:outline-none" onClick={() => setShowPassword(!showPassword)}>
                <svg className="flex-shrink-0 w-5 h-5 text-gray-400 dark:text-neutral-600" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M9.88 9.88a3 3 0 1 0 4.24 4.24" />
                  <path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68" />
